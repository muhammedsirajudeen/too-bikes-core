...
import { Plus, Pencil, Trash2, Store as StoreIcon, Search } from "lucide-react";
...
export default function StoresPage() {
    ...
    useEffect(() => {
        fetchStores();
    }, [currentPage, debouncedSearchQuery, filterDistrict]);
    ...
    return (
        <AdminLayout pageTitle="Store Management" pageSubtitle="Workspace">
